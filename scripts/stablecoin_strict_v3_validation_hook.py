...
TRIGGER = (
    ...
    / "research"
    / "execution"
    / "stablecoin_strict_visible_20260727"
    / "TRIGGER_20260727_005_CANONICAL_SOURCE3631_STRICT209A.json"
)
CORRECTION = (
    ROOT
    / "research"
    ...
    / "EXECUTION_CORRECTION_CANONICAL_004.json"
)
RUNNER_TEMP = Path(os.environ.get("RUNNER_TEMP", "/tmp"))
WORK = RUNNER_TEMP / "stablecoin_strict_v3_validation_hook_004"
OUT = WORK / "output"
MARKET = WORK / "market"
MARKER = RUNNER_TEMP / "stablecoin_strict_v3_validation_hook_004_summary.json"
    ...
    if not result_path.exists():
        run(
            [
                ...
                str(source_out),
                "--transport",
                "TRANSPORT-20260727-ML-STABLECOIN-STRICT-VALIDATOR-HOOK-004",
                "--exit-code",
                str(source_rc),
            ]
        )
