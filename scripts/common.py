...
def _run_dense_liquidation_source_hook() -> None:
    trigger = ROOT / "research" / "ml_binance_liquidation_dense_20260726" / "RUN_VIA_VALIDATE_PROJECT_20260727T0015KST.txt"
...
_run_dense_liquidation_source_hook()
