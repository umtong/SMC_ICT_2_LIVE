...
The run downloads only the preregistered 2023 BTCUSDT/ETHUSDT daily archives. It writes source hashes, fit thresholds, development diagnostics, all candidate metrics, a compact result summary and an artifact inventory.
